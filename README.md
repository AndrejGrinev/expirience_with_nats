Предпосылка - существует большой монолит [ТендерПро](https://github.com/TenderPro). Возникла дискуссия - можно ли малой кровью и необходимо ли вообще пилить его на микросервисы?
